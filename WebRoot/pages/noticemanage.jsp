                    ...
                    <c:forEach items="${ noticeall}" var="item">
                        ...
                        <tr>
                            ...
                            <td> <!-- 将图片从服务器中获取并使用img展示，设置其宽高为100px -->
                                ...
                                <a href="resource/uploads/${item.pic }"><img src="resource/uploads/${item.pic }"
                            ...
                            <td>
                                ...
                                <!--  定义修改公告按钮和删除公告按钮，修改提交地址为updatenotice.action?id=${item.id}，删除提交地址为 deletenotice.action?id=${item.id}-->

                                <a href="updatenotice.action?id=${item.id}">修改</a> <a
                                    href="deletenotice.action?id=${item.id}">删除</a>
