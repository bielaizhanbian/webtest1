...
<div id="kv2jg8jy">
    ...
    <div id="kv2no1ui">
        <div id="kv2nq1xw">
            <form method="post" qw-c="operationform" action="updatenoticeact.action" enctype="multipart/form-data">
                <input name='id' style='display:none;' value="${notice.id}">
                <div class="form-group" qw-c="forminputcomponent">
                    <label qw-c="forminputtext">标题</label>
                    <div class="controls">
                        <!-- 定义标题input输入框，并从request中取值notice.title赋值  -->

                        <input name="title" value="${notice.title}" class="form-control" qw-c="forminput">
                    </div>
                </div>
                <div class="form-group" qw-c="forminputcomponent">
                    ...
                    <div class="controls">
                        ...
                        <input type="file" name="picfile" value="${notice.pic}" class="form-control" qw-c="forminput">
                    </div>
                </div>
                <div class="form-group" qw-c="formtextareacomponent">
                    ...
                    <div class="controls">
                        <textarea name="comtent" class="form-control" style="height: 200px;"
                                  qw-c="formtextarea">${notice.comtent}</textarea>
                    </div>
                </div>
                <div class="form-group" qw-c="forminputcomponent">
                    ...
                    <div class="controls">
                        ...
                        <input type="text" readonly value="${notice.addtime}" name="addtime" class="form-control"
                               qw-c="forminput">
                    </div>
                </div>
                <div class="form-group" qw-c="forminputcomponent">
                    ...
                    <div class="controls">
                        <!-- 定义发布人input输入框，并从request中取值notice.publisher赋值  -->

                        <input name="publisher" value="${notice.publisher}" class="form-control" qw-c="forminput">
                    </div>
                </div>


                <div class="form-group">
                    <button class="btn btn-primary" qw-c="operationbutton">修改</button>
                </div>
            </form>
        </div>
    </div>
