    ...
    <div id="kv2no1ui">
        <div id="kv2nq1xw">
            ...
            <table class="table table-hover table-striped table-bordered" qw-c="table">
                ...
                <c:if test="${ !empty chatall}">

                    <c:forEach items="${ chatall}" var="item">


                        <tr>
                            <td> ${item.senderidentity }

                            </td>
                            <td> ${item.sendername }

                            </td>
                            <td> ${item.receiveridentity }
                            ...
                            <td>
                                ...
                                <!--  定义修改聊天按钮和删除聊天按钮，修改提交地址为updatechat.action?id=${item.id}，删除提交地址为 deletechat.action?id=${item.id}-->


                                <a href="chat.action?toid=1&toidentity=%E7%94%A8%E6%88%B7&toname=张三">聊天</a>
                                <a href="updatechat.action?id=${item.id}">修改</a>
                                <a href="deletechat.action?id=${item.id}">删除</a>
