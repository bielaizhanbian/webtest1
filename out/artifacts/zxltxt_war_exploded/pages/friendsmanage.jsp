    ...
    <div id="kv2no1ui">
        <div id="kv2nq1xw">
            ...
            <table class="table table-hover table-striped table-bordered" qw-c="table">
                ...
                <c:if test="${ !empty friendsall}">

                    <c:forEach items="${ friendsall}" var="item">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!--  定义修改好友按钮和删除好友按钮，修改提交地址为updatefriends.action?id=${item.id}，删除提交地址为 deletefriends.action?id=${item.id}-->

                                <a href="updatefriends.action?id=${item.id}">修改</a> <a
                                    href="deletefriends.action?id=${item.id}">删除</a>
