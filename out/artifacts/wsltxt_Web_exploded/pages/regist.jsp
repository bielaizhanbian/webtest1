...
<body style="background: url(resource/houtai/img/5.jpg);background-size: cover">
<div id="kv2jbf78">
    <form action="registact.action" qw-c="form" method="post">
        ...
        <div class="form-group" qw-c="passwordcomponent"><input class="form-control" placeholder="请确认密码" qw-c="password"
                                                                name="repassword" type="password"></div>
        ...
        <div class="form-group">
            <button class="btn btn-primary" qw-c="operationbutton">注册</button>
        </div>
    </form>
    <div qw-c="infotext">
