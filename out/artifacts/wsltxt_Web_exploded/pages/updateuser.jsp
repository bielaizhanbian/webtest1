        ...
        <div id="kv2nq1xw">
            <form method="post" qw-c="operationform" action="updateuseract.action" enctype="multipart/form-data">
                ...
                <div class="form-group" qw-c="forminputcomponent">
                    ...
                    <div class="controls">
                        <!-- 定义姓名input输入框，并从request中取值user.name赋值  -->
                ...
                <div class="form-group" qw-c="formselectcomponent">
                    ...
                    <div class="controls">
                        ...
                        <select id='sex' onchange="sexchange(this)" name="sex" class="form-control" qw-c="formselect">
                            <option>男</option>
                            <option>女</option>
                        </select>
                        <script>
                ...
                <div class="form-group" qw-c="forminputcomponent">
                    <label qw-c="forminputtext">邮箱</label>
                    <div class="controls">
                        <!-- 定义邮箱input输入框，并从request中取值user.age赋值  -->

                        <input name="age" value="${user.age}" class="form-control" qw-c="forminput">
                    </div>
                </div>
                <div class="form-group" qw-c="forminputcomponent">
                    <label qw-c="forminputtext">手机号</label>
                    <div class="controls">
                        <!-- 定义手机号input输入框，并从request中取值user.phone赋值  -->

                        <input name="phone" value="${user.phone}" class="form-control" qw-c="forminput">
                    </div>
                </div>
