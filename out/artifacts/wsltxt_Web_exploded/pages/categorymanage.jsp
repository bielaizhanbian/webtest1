                    ...
                    <c:forEach items="${ categoryall}" var="item">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!--  定义修改分组按钮和删除分组按钮，修改提交地址为updatecategory.action?id=${item.id}，删除提交地址为 deletecategory.action?id=${item.id}-->

                                <a href="updatecategory.action?id=${item.id}">修改</a> <a
                                    href="deletecategory.action?id=${item.id}">删除</a>
